<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center"> <img src="assets/img/logo.png" alt=""> <span
                    class="d-none d-lg-block">Logo</span>
...
<!--                 <input type="text" name="query" placeholder="Tìm kiếm..." title="Nhập thông tin bạn muốn tìm..."> -->
...
<!--                             class="bi bi-bell"></i> <span class="badge bg-primary badge-number">4</span> -->
<!--                     </a> -->
<!--                     End Notification Icon -->

<!--                     <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications"> -->
<!--                         <li class="dropdown-header">You have 4 new notifications <a href="#"><span -->
<!--                                     class="badge rounded-pill bg-primary p-2 ms-2">Xem -->
<!--                                     tất cả</span></a> -->
<!--                         </li> -->
<!--                         <li> -->
...
<!--                 </li> -->
                ...
                <li class="nav-item dropdown pe-3"><a class="nav-link nav-profile d-flex align-items-center pe-0"
                        href="#" data-bs-toggle="dropdown"> <i class="bi bi-person-fill" style="height: 100%; width: auto;"></i>
                            <span class="d-none d-md-block dropdown-toggle ps-2">
                            	${sessionScope.userLogined.userUsername}
                            </span>
                    </a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6>${sessionScope.userLogined.userFullname}</h6> 
...
<%--                         <li><a class="dropdown-item d-flex align-items-center" href="${pageContext.request.contextPath}/account"> <i --%>
<!--                                     class="bi bi-person"></i> <span>Tài khoản</span> -->
<!--                             </a></li> -->
