  							...
  							<c:forEach var="row" items="${roomList}">
									<tr>
										...
										<td class="align-middle">
											<c:choose>
												<c:when test="${not empty row['room_image']}">
													<img src="data:image/jpeg;base64,${row['room_image']}" alt="Room Image"
										...
										<td class="align-middle">${row['room_size']}</td>
										<td class="align-middle">${row['room_bed_count']}</td>
										<td class="align-middle">${row['room_star_count']}</td>
										<td class="align-middle">${row['room_price_per_hour_vnd']}</td>
										<td class="align-middle">${row['room_is_available'] == true ? 'Có' : 'Không'}</td>
										<td class="align-middle">${row['room_note']}</td>
										<td class="align-middle">
											...
											<button type="button" class="btn btn-warning btn-action" data-bs-toggle="modal" data-bs-target="#editPhongModal${row['room_id']}">
												<!-- <i class="bi bi-pencil-square"></i> --> 
												Sửa 
											</button>
											<!-- Modal Sửa Phòng -->
											<div class="modal fade" id="editPhongModal${row['room_id']}" tabindex="-1" aria-labelledby="editPhongModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="editPhongModalLabel">
																Sửa phòng có ID: ${row['room_id']}
															</h5>
															...
															<form action="${pageContext.request.contextPath}/room" method="post" enctype="multipart/form-data">
																...
																<div class="mb-3">
																	<span class="form-switch me-${row['room_id']}">
																		<input class="form-check-input" type="checkbox" id="is_update_room_image_${row['room_id']}" name="is_update_room_image" onchange="toggleInput('is_update_room_image_${row['room_id']}', 'room_image_${row['room_id']}')">
																	</span>
																...
																<div class="mb-3">
																	...
																	<input type="number" class="form-control" id="room_size" name="room_size" value="${row['room_size']}" required>
																</div>
								
																<!-- số giường -->
																<div class="mb-3">
																	<label for="room_bed_count" class="form-label">Số giường</label>
																	<select class="form-select" id="room_bed_count"
																		name="room_bed_count"
																...
																<div class="mb-3">
																	...
																	<select class="form-select" id="room_star_count"
																		name="room_star_count"
																		aria-label="Floating label select example">
																...
																<div class="mb-3">
																	...
																	<input type="number" class="form-control" id="room_price_per_hour_vnd" name="room_price_per_hour_vnd" value="${row['room_price_per_hour_vnd']}" required>
																</div>
																...
																<div class="mb-3">
																	...
																	<textarea class="form-control" id="room_note" name="room_note" rows="3" required>
																		${row['room_note']}
																	</textarea>
																</div>
